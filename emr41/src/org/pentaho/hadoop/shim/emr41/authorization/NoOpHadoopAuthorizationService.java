...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.emr41.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.emr41.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.emr41.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.emr41.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.emr41.HBaseShimImpl() );
    try {
