...
public class ColumnFilter {
  ...
  /**
   * Holds the type of the field at the time this filter was defined - allows easy checking at runtime in case the user
   * has switched mappings but not updated their filters.
   */
