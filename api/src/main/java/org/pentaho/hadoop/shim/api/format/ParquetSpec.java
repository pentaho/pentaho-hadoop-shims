...
public class ParquetSpec {
  public enum DataType {
    ...
    UTF8( 20, false, "binary", null, true, "UTF8", ValueMetaInterface.TYPE_STRING ),
    TIME_MILLIS( 21, false, "int32", null, true, "TimeMillis", ValueMetaInterface.TYPE_TIMESTAMP ),
    TIMESTAMP_MILLIS( 22, false, "int64", null, true, "TimestampMillis", ValueMetaInterface.TYPE_TIMESTAMP ),
    BSON( 23, false, "binary", null, false, "BSON", ValueMetaInterface.TYPE_NONE ),
    INTERVAL( 24, false, "fixed_len_byte_array", null, false, "Interval", ValueMetaInterface.TYPE_NONE ),
    JSON( 25, false, "binary", null, false, "JSON", ValueMetaInterface.TYPE_NONE ),
    LIST( 26, false, "", null, false, "List", ValueMetaInterface.TYPE_NONE ),
    MAP( 27, false, "", null, false, "Map", ValueMetaInterface.TYPE_NONE ),
    MAP_KEY_VALUE( 28, false, "", null, false, "MapKeyValue", ValueMetaInterface.TYPE_NONE ),
    STRUCT( 29, false, "", null, false, "Struct", ValueMetaInterface.TYPE_NONE ),
    UNION( 30, false, "", null, false, "Union", ValueMetaInterface.TYPE_NONE );
