...
public class ColumnFilterTest extends ColumnFilter {
  ...
  public void testGetFilter() throws Exception {
    ...
    assertTrue( equalsCF( cf, ColumnFilter.getFilter( node ) ) );
  }
  ...
  public void testGetFilterFromRepo() throws Exception {
    ...
    assertTrue( equalsCF( cf, ColumnFilter.getFilter( rep, 0, mock( ObjectId.class ) ) ) );
  }

  @Test
  public void testStringToOpp() throws Exception {
    assertEquals( ComparisonType.EQUAL, ColumnFilter.stringToOpp( "=" ) );
    assertEquals( ComparisonType.GREATER_THAN, ColumnFilter.stringToOpp( ">" ) );
    assertEquals( ComparisonType.GREATER_THAN_OR_EQUAL, ColumnFilter.stringToOpp( ">=" ) );
    assertEquals( ComparisonType.LESS_THAN, ColumnFilter.stringToOpp( "<" ) );
    assertEquals( ComparisonType.LESS_THAN_OR_EQUAL, ColumnFilter.stringToOpp( "<=" ) );
    assertEquals( ComparisonType.NOT_EQUAL, ColumnFilter.stringToOpp( "!=" ) );
    assertEquals( ComparisonType.PREFIX, ColumnFilter.stringToOpp( "Starts from" ) );
    assertEquals( ComparisonType.REGEX, ColumnFilter.stringToOpp( "Regular expression" ) );
    assertEquals( ComparisonType.SUBSTRING, ColumnFilter.stringToOpp( "Substring" ) );
  }

  @Test
  public void testGetAllOperators() throws Exception {
    assertEquals( 9, ColumnFilter.getAllOperators().length );
  }

  @Test
  public void testGetStringOperators() throws Exception {
    assertEquals( 3, ColumnFilter.getStringOperators().length );

  }

  @Test
  public void testGetNumericOperators() throws Exception {
    assertEquals( 6, ColumnFilter.getNumericOperators().length );
  }
