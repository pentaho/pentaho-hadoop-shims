...
package org.pentaho.hadoop.shim.mapr500.authorization;
...
import org.pentaho.hbase.shim.mapr500.wrapper.HBaseShimInterface;
...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.mapr500.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.mapr500.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.mapr500.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.mapr500.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.mapr500.MapRHBaseShim() );
    try {
