...
import org.pentaho.hadoop.shim.mapr31.SnappyShim;
...
public class ShimNoOpHadoopAuthorizationService extends NoOpHadoopAuthorizationService {
  ...
  @Override protected CommonSqoopShim getSqoopShim() {
    return new CommonSqoopShim();
  }

  @Override protected CommonSnappyShim getSnappyShim() {
    return new SnappyShim();
  }
}