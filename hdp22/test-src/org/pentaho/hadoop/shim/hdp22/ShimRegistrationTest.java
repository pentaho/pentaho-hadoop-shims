...
public class ShimRegistrationTest {
  ...
  public void hadoopShimRegistered() {
    ...
    assertTrue( org.pentaho.hadoop.shim.hdp22.HadoopShim.class.isAssignableFrom( s.getClass() ) );
  }
  ...
  public void sqoopShimRegistered() {
    ...
    assertTrue( org.pentaho.hadoop.shim.hdp22.ClassPathModifyingSqoopShim.class.equals( s.getClass() ) );
  }
  ...
  public void snappyShimRegistered() {
    ...
    assertTrue( org.pentaho.hadoop.shim.hdp22.SnappyShim.class.isAssignableFrom( s.getClass() ) );
  }
  ...
  public void hbaseShimRegistered() {
    ...
    assertTrue( org.pentaho.hbase.shim.hdp22.HBaseShimImpl.class.isAssignableFrom( s.getClass() ) );
  }
}
