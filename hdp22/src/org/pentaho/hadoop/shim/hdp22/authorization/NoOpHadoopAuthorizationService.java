...
import org.pentaho.hbase.shim.hdp22.wrapper.HBaseShimInterface;
...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.hdp22.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.hdp22.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.hdp22.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.hdp22.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.hdp22.HBaseShimImpl() );
    try {
