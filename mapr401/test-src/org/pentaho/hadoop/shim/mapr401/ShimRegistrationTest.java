...
public class ShimRegistrationTest {
  ...
  public void pigShimRegistered() {
    ...
    assertTrue(PigShim.class.isAssignableFrom(s.getClass()));
  }
  ...
  public void snappyShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.mapr401.SnappyShim.class.isAssignableFrom(s.getClass()));
  }
  ...
  public void hbaseShimRegistered() {
    ...
    assertTrue(org.pentaho.hbase.shim.mapr401.MapRHBaseShim.class.isAssignableFrom(s.getClass()));
  }
}
