...
package org.pentaho.hadoop.shim.cdh52;
...
public class ShimRegistrationTest {
  ...
  public void hadoopShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.cdh52.HadoopShim.class.isAssignableFrom(s.getClass()));
  }
  ...
  public void sqoopShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.cdh52.ClassPathModifyingSqoopShim.class.equals(s.getClass()));
  }
  ...
  public void snappyShimRegistered() {
    ...
    assertTrue(org.pentaho.hadoop.shim.cdh52.SnappyShim.class.isAssignableFrom(s.getClass()));
  }
  ...
  public void hbaseShimRegistered() {
    ...
    assertTrue(org.pentaho.hbase.shim.cdh52.HBaseShimImpl.class.isAssignableFrom(s.getClass()));
  }
}
