...
package org.pentaho.hadoop.shim.emr310.authorization;
...
import org.pentaho.hbase.shim.emr310.wrapper.HBaseShimInterface;
...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.emr310.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.emr310.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.emr310.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.emr310.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.emr310.HBaseShimImpl() );
    try {
