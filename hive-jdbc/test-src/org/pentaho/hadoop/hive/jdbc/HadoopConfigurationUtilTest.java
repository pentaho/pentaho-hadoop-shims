...
public class HadoopConfigurationUtilTest {
  ...
  public static void init() throws KettleException {
    ...
    PluginMainClassType mainClassTypesAnnotation =
      KettleLifecyclePluginType.class.getAnnotation( PluginMainClassType.class );
    PluginInterface hadoopConfigurationBootstrap =
      new Plugin( new String[] { "HadoopConfigurationBootstrap" }, StepPluginType.class,
        mainClassTypesAnnotation.value(), "", "", "", null, false, false, new HashMap<Class<?>, String>(),
