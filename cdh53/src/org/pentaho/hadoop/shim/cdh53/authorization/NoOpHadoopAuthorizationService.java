...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.cdh53.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.cdh53.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.cdh53.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.cdh53.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.cdh53.HBaseShimImpl() );
    try {
