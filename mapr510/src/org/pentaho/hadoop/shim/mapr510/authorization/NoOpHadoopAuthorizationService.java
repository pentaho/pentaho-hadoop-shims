...
import org.pentaho.hbase.shim.mapr510.wrapper.HBaseShimInterface;
...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.mapr510.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.mapr510.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.mapr510.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.mapr510.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.mapr510.MapRHBaseShim() );
    try {
