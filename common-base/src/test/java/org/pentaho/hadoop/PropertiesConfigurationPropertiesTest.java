...
public class PropertiesConfigurationPropertiesTest {
  ...
  public void fileBackedPutPersistsAndReReads() throws Exception {
    ...
    try {
      ...
      assertTrue( "File should contain persisted property: " + persisted, 
        persisted.contains( "new.key" ) && persisted.contains( "new.value" ) );

      PropertiesConfigurationProperties reloaded = new PropertiesConfigurationProperties( resolve( file ) );
