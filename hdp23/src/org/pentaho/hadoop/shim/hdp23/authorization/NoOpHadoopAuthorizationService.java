...
import org.pentaho.hbase.shim.hdp23.wrapper.HBaseShimInterface;
...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.hdp23.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.hdp23.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.hdp23.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.hdp23.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.hdp23.HBaseShimImpl() );
    try {
