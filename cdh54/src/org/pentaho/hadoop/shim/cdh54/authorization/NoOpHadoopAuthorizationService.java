...
import org.pentaho.hbase.shim.cdh54.wrapper.HBaseShimInterface;
...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.cdh54.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.cdh54.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.cdh54.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.cdh54.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.cdh54.HBaseShimImpl() );
    try {
