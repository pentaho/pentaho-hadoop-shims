...
import org.pentaho.hadoop.shim.hsp101.ClassPathModifyingSqoopShim;
...
import org.pentaho.hbase.shim.hsp101.HBaseShimImpl;
...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.hsp101.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.hsp101.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.hsp101.SnappyShim() );
    shimMap.put( SqoopShim.class, new ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new HBaseShimImpl() );
    try {
