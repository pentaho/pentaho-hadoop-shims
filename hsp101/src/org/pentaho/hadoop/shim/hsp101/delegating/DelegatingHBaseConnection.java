...
package org.pentaho.hadoop.shim.hsp101.delegating;

import org.pentaho.di.core.variables.VariableSpace;
import org.pentaho.hadoop.shim.api.Configuration;
import org.pentaho.hbase.shim.api.ColumnFilter;
import org.pentaho.hbase.shim.api.HBaseValueMeta;
import org.pentaho.hbase.shim.hsp101.wrapper.HBaseConnectionInterface;
...
public class DelegatingHBaseConnection extends HBaseConnection implements HBaseConnectionInterface {
   ...
   *
   * @see
   * org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#addColumnFilterToScan(org.pentaho.hbase
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#addColumnToScan(java.lang.String,
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#addColumnToTargetPut(java.lang.String,
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#checkForHBaseRow(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#checkHBaseAvailable()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#closeSourceResultSet()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#closeSourceTable()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#closeTargetTable()
   */
  @Override
   ...
   *
   * @see
   * org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#configureConnection(java.util.Properties,
   * java.util.List)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#createTable(java.lang.String,
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#deleteTable(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#disableTable(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#enableTable(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#equals(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#executeSourceTableScan()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#executeTargetTableDelete(byte[])
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#executeTargetTablePut()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#flushCommitsTargetTable()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getBloomTypeClass()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getByteArrayComparableClass()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getBytesUtil()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getCompressionAlgorithmClass()
   */
  @Override
   ...
   *
   * @see
   * org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getDeserializedBooleanComparatorClass()
   */
  @Override
   ...
   *
   * @see
   * org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getDeserializedNumericComparatorClass()
   */
  @Override
   ...
   *
   * @see
   * org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getResultSetCurrentRowColumnLatest(java
   ...
   *
   * @see
   * org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getResultSetCurrentRowFamilyMap(java.lang
   * .String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getResultSetCurrentRowKey()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getResultSetCurrentRowMap()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getRowColumnLatest(java.lang.Object,
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getRowFamilyMap(java.lang.Object,
   * java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getRowKey(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getRowMap(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#getTableFamiles(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#hashCode()
   */
  @Override
  public int hashCode() {
   ...
   *
   * @see
   * org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#isImmutableBytesWritable(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#isTableAvailable(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#isTableDisabled(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#listTableNames()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#newSourceTable(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#newSourceTableScan(byte[], byte[],
   * int)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#newTargetTable(java.lang.String,
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#newTargetTablePut(byte[], boolean)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#resultSetNextRow()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#sourceTableRowExists(byte[])
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#tableExists(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.pentaho.hadoop.shim.hdp21.delegatingShims.HBaseConnectionInterface#targetTableIsAutoFlush()
   */
  @Override
