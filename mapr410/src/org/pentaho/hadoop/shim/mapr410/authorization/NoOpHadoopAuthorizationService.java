...
import org.pentaho.hbase.shim.mapr410.wrapper.HBaseShimInterface;
...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.mapr410.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.mapr410.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.mapr410.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.mapr410.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.mapr410.MapRHBaseShim() );
    try {
