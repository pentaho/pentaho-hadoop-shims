...
public class HBaseTableImplTest {
  ...
  public void testCreateWriteOperationManagerSuccessNotNullBufferSize() throws IOException {
    ...
    properties.setProperty( org.pentaho.hadoop.shim.spi.HBaseConnection.HTABLE_WRITE_BUFFER_SIZE_KEY,
  ...
  public void testCreateScannerBuilderFullArgsEmptyKeyStart() throws KettleException {
    ...
    assertNotNull( hBaseTable
      .createScannerBuilder( tableMapping, "testConvMask", null, null, scannerCacheSizeVar, logChannelInterface,
        variableSpace ) );
  }
