...
public class MappingTest {
  ...
  public static final String XML_NODE =
    "<mapping>      <mapping_name>mapping_name</mapping_name>      <table_name>table_name</table_name>      "
      + "<key>key</key>      <key_type>String</key_type>        <mapped_columns>        <mapped_column>          "
      + "<alias>alias_2</alias>          <column_family>col_family_2</column_family>          "
      + "<column_name>col_name_2</column_name>          <type>String</type>        </mapped_column>        "
      + "<mapped_column>          <alias>alias_1</alias>          <column_family>col_family_1</column_family>        "
      + "  <column_name>col_name_1</column_name>          <type>Double</type>        </mapped_column>        "
    ...
    doAnswer( new Answer() {
      ...
      @Override public Object answer( InvocationOnMock invocation ) throws Throwable {
        ...
        switch ( code ) {
          ...
          case "key_type": {
            assertEquals( KEY_TYPE.toString(), value );
            break;
          }
          case "alias": {
