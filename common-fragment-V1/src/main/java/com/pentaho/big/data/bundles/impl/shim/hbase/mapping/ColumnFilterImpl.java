...
public class ColumnFilterImpl implements ColumnFilter {
  ...
  @Override public ComparisonType getComparisonOperator() {
    org.pentaho.hadoop.shim.api.internal.hbase.ColumnFilter.ComparisonType comparisonOperator = delegate.getComparisonOperator();
  ...
  @Override public void setComparisonOperator( ComparisonType c ) {
    if ( c == null ) {
      ...
      delegate.setComparisonOperator( org.pentaho.hadoop.shim.api.internal.hbase.ColumnFilter.ComparisonType.valueOf( c.name() ) );
    }
  }
