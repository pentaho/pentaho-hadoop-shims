...
REM ===========================================
set LIBSPATH=libswt\win32;native-lib\win32;..\native-lib\win32
GOTO :CONTINUE
:USE64
REM ===========================================
...
REM Remove old webservices libraries
if exist "%KETTLE_DIR%\lib\webservices-api-2.3.1.jar" (
    echo Removing old webservices-api libraries from lib folder...
    del /f "%KETTLE_DIR%\lib\webservices-api-2.3.1.jar"
)
if exist "%KETTLE_DIR%\lib\webservices-rt-2.3.1.jar" (
    echo Removing old webservices-rt libraries from lib folder...
    del /f "%KETTLE_DIR%\lib\webservices-rt-2.3.1.jar"
)
