...
public class HadoopShim extends HadoopShimImpl {
  ...
  public Class[] getHbaseDependencyClasses() {
    return new Class[] {
      ...
      Snapshot.class, ZooKeeper.class, Channel.class, Message.class, UnsafeByteOperations.class, Lists.class, MetricRegistry.class, ArrayUtils.class, ObjectMapper.class, Versioned.class,
