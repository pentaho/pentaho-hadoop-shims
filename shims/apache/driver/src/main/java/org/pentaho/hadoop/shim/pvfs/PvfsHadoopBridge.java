...
import org.pentaho.hadoop.shim.pvfs.conf.AzDataLakeGen2Conf;
...
public class PvfsHadoopBridge extends FileSystem implements PvfsHadoopBridgeFileSystemExtension {
  ...
  public PvfsHadoopBridge() {
    confFactories = Arrays.asList( S3Conf::new, HCPConf::new, SnwConf::new, GcsConf::new, AzDataLakeGen2Conf::new );
