...
public class ADLSGen2Conf extends PvfsConf {
  ...
  public Configuration conf( Path pvfsPath ) {
    ...
    if ( !isNullOrEmpty( sharedKey ) ) {
      ...
      config.set( "fs.azure.account.oauth.provider.type." + accountName + ".dfs.core.windows.net",
        "org.apache.hadoop.fs.azurebfs.oauth2.ClientCredsTokenProvider" );
      config.set( "fs.azure.account.oauth2.client.endpoint." + accountName + ".dfs.core.windows.net",
