...
package org.pentaho.hadoop.shim.cdh55.authorization;
...
import org.pentaho.hbase.shim.cdh55.wrapper.HBaseShimInterface;
...
public class NoOpHadoopAuthorizationService implements HadoopAuthorizationService {
  ...
  public NoOpHadoopAuthorizationService() {
    ...
    shimMap.put( HadoopShim.class, new org.pentaho.hadoop.shim.cdh55.HadoopShim() );
    shimMap.put( PigShim.class, new org.pentaho.hadoop.shim.cdh55.PigShim() );
    shimMap.put( SnappyShim.class, new org.pentaho.hadoop.shim.cdh55.SnappyShim() );
    shimMap.put( SqoopShim.class, new org.pentaho.hadoop.shim.cdh55.ClassPathModifyingSqoopShim() );
    shimMap.put( HBaseShimInterface.class, new org.pentaho.hbase.shim.cdh55.HBaseShimImpl() );
    try {
