...
// that contains the PentahoMapRunnable class. It does this by calling Class.forName("org.pentaho.hadoop.mapreduce.<classname>).
...
// Class.forName("org.pentaho.hadoop.mapreduce.PentahoMapRunnable") from the shim, because the class doesn't load properly.
