...
public class CommonFormatShimTestIT {
  ...
  public void testParquetReadSuccessLocalFileSystem() throws Exception {
    ...
    PentahoTwitterInputFormat pentahoParquetInputFormat = new PentahoTwitterInputFormat( mock( NamedCluster.class ) );
  ...
  public void testParquetWriteSuccessLocalFileSystem() throws Exception {
    ...
    PentahoTwitterOutputFormat pentahoParquetOutputFormat =
      new PentahoTwitterOutputFormat();
