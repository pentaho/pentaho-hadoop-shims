 ...
 */
public class TwitterInputFormat extends HadoopFormatBase implements IPentahoParquetInputFormat {

  private static final Logger logger = Logger.getLogger( TwitterInputFormat.class );

  private ParquetInputFormat<RowMetaAndData> nativeParquetInputFormat;
  private Job job;

  public TwitterInputFormat( NamedCluster namedCluster ) throws Exception {
