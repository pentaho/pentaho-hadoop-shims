 ...
 */
public class TwitterOutputFormat extends HadoopFormatBase implements IPentahoParquetOutputFormat {

  private static final Logger logger = Logger.getLogger( TwitterOutputFormat.class );
  ...
  public TwitterOutputFormat() throws Exception {
