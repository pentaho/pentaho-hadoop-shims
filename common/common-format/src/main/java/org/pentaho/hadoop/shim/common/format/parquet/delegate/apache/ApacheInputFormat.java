 ...
 */
public class ApacheInputFormat extends HadoopFormatBase implements IPentahoParquetInputFormat {

  private static final Logger logger = Logger.getLogger( ApacheInputFormat.class );

  private ParquetInputFormat<RowMetaAndData> nativeParquetInputFormat;
  private Job job;

  public ApacheInputFormat( NamedCluster namedCluster ) throws Exception {
